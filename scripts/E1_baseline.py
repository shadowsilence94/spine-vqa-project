...
def main():
    ...
    for epoch in range(1, cfg.EPOCHS + 1):
        ...
        wandb.log({"epoch": epoch, "train_loss": train_loss, "train_acc": train_acc, "cls_acc": metrics["cls_acc"], "loc_exact_acc": metrics["loc_exact_acc"], "precision": metrics["precision"], "recall": metrics["recall"], "overall_acc": metrics["overall_acc"], "lr": current_lr})
        current_lr = scheduler.get_last_lr()[0]
